...
function ValidateTmAskDemandePage()
{
    ...
    const columns = [
    ...
    
        {
          ...
          selector : row => (
            <>
                ...
                {row.status == 3 && <span class="badge bg-danger">Attente contrat</span>}
        ...
        },
        {
            ...
            selector : row => (
                <>
                {row.status == 3 ?
                <Link className="btn btn-primary btn-sm me-2" to={`/affect-tm-en-attente/${row.uuid}`}> <i className="fa fa-plus"></i> Valider</Link>
                : 
    ...
    useEffect(()=>{
        if(!can(permissions,'demande-tm-list')){
    ...
    function get_demande_affectatiion()
    {
        setLoading(true);
        try {
            axios.get(url.base+'/affect-en-attente-validation-tm',{
                headers:{
            ...
            <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="mb-5">
                                <h3 class="mb-0 ">Liste des affectations en attente de validation TM
...
export default ValidateTmAskDemandePage;