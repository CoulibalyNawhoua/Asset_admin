...
function SocieteUserPage(){
    ...
    const fetchUserList = async ()=>{
        setLoading(true);
        try {
            axios.get(url.base+'/myusers-listes',{
                headers:{
    ...
    return (
        <>
            <ContentSection ulShownav={"cores"} navactive={"meusers"}>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <div class="mb-5">
                        ...
                        <Link  class="btn btn-primary me-2 float-end btn-sm" to='/all-create-users'>Ajouter</Link>
                        </h3>
...
export default SocieteUserPage;