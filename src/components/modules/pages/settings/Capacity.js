...
function CapacitePage(){
    ...
    const columns = [
...

        {
            ...
            selector : row => (
                <>
                {can(permissions,"add-update-capacite") && 
    ...
    useEffect(()=>{
        if(!can(permissions,'capacite-list')){
    ...
    const submitForm= (e)=>{
        ...
        setLoadingf(true);
        try {
            axios.post(url.base+'/store-capacites',_formData,
            {
                headers:{
                    'Content-Type':'application/json',
                    "Authorization": `Bearer ${localStorage.getItem('_token_')}`
    ...
    const submitFormEdit= (e)=>{
        ...
        setLoadingf(true);
        try {
            axios.post(url.base+'/capacite-update/'+item.id,_formData,
            {
                headers:{
                    'Content-Type':'application/json',
                    "Authorization": `Bearer ${localStorage.getItem('_token_')}`
    ...
    return (
        <>
            <ContentSection ulShownav={"parametres"} navactive={"capacites"}>
            <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">
                            
                            <div class="mb-5">
                                <h3 class="mb-0 ">Liste des Capacités</h3>
