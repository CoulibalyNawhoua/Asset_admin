...
function TransfertPageMateriel(){
    ...
    const columns = [
        ...
        },
        {
            ...
            selector : row => (
                <>
                  {can(permissions,'detail-transfert') && <Link className="btn btn-primary btn-sm mx-1" to={`/tranfert-detail/${row.uuid}`}><i class="fa-solid fa-eye"></i>Voir</Link> }
                </>
            )
          },
    ...
    const fetchTransfertList = async ()=>{
        setLoading(true);
        try {
            axios.get(url.base+'/transfert-materiels-list',{
                headers:{
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">
                            ...
                            <div class="mb-5">
                                <h3 class="mb-0 ">Liste des transferts 
...
export default TransfertPageMateriel;