...
function InStockMaterielPage(){
    ...
    const fetchItemsList = async ()=>{
        setLoading(true);
        try {
            axios.get(url.base+'/materiels-available',{
                headers:{
    ...
    return (
        <>
            <ContentSection ulShownav={"managements"} navactive={"in-stock-mat"}>
            <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">
                            
                            <div class="mb-5">
                                <h3 class="mb-0 ">Liste des matériaux en stock ({itemsList?.length})
...
export default InStockMaterielPage;