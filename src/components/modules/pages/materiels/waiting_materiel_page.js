...
function MaterielEnAttenteDeTraitement()
{
    ...
    const fetchItemsList = async ()=>{
        setLoading(true);
        try {
            axios.get(url.base+'/materiels-waiting',{
                headers:{
    ...
    return (
        <>
            <ContentSection ulShownav={"managements"} navactive={"en-attente-mat"}>
                <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-12">
                                
                                <div class="mb-5">
                                    <h3 class="mb-0 ">Liste des matériaux en attente d'affectation ({itemsList.length})
...
export default MaterielEnAttenteDeTraitement;